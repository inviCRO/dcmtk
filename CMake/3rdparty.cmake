IF(WIN32)
  ...
  IF(DCMTK_WITH_XML)
    IF(WITH_LIBXMLINC)
      SET(LIBXML_INCDIR ${WITH_LIBXMLINC}/include ${WITH_LIBXMLINC}/include/iconv)
      SET(LIBXML_LIBDIR ${WITH_LIBXMLINC}/lib)
      SET(LIBXML_LIBS debug libxml2d optimized libxml2)
  ...
  IF(DCMTK_WITH_TIFF)
    IF (WITH_LIBTIFFINC)
      ...
      SET(LIBTIFF_LIBS debug libtiffd optimized libtiff)
  ...
  IF(DCMTK_WITH_ZLIB)
    IF(WITH_ZLIBINC)
      ...
      SET(ZLIB_LIBS debug zlibd optimized zlib)
